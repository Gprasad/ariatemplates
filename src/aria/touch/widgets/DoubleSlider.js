...
Aria.classDefinition({
    ...
    $dependencies : ['aria.touch.widgets.SliderCfgBeans', 'aria.touch.DoubleSwipe', 'aria.utils.Dom', 'aria.utils.Type'],
    /**
     * Slider Constructor.
    ...
    $constructor : function (cfg, context, lineNumber) {
         ...
         * @protected
         */
        this._maxLeftPositionFirst = this._cfg.width - ((this.BUTTON_WIDTH + this.BORDER_WIDTH) * 2);
        /**
         * Maximum left position for the second thumb in pixels.
         * @type Number
         * @protected
         */
        this._maxLeftPositionSecond = this._cfg.width - (this.BUTTON_WIDTH + this.BORDER_WIDTH);
        /**
         ...
         * @protected
         */
        this._minLeftSecond = this.BUTTON_WIDTH + this.BORDER_WIDTH;
    ...
    $destructor : function () {
        ...
        this._secondaryDomId = null;
        this._savedX1 = null;
        this._savedX2 = null;
        this._needUpdate = null;
        this._maxLeftPositionFirst = null;
        this._maxLeftPositionSecond = null;
        this._minLeftFirst = null;
        this._minLeftSecond = null;
        this._firstSlider = null;
        this._secondSlider = null;
    ...
    $prototype : {
        ...
        _updateDisplay : function (second) {
            ...
            offset = this.BORDER_WIDTH + this.BUTTON_WIDTH;
            if (this._leftPositionSecond < this._leftPositionFirst + offset) {
                return;
            }
