                            ...
                            if (suggestion.code === textEntry) {
                                ...
                                for (var j = 0, len = boundaries.length, boundary; j < len; j++) {
                                    ...
                                    if (exactMatch) {
                                        ...
                                        if (aria.utils.Array.indexOf(callback.scope._selectedSuggestions, suggestion.original.label) == -1)
                                            suggestionsContainer.push(suggestion.original);
                                        // suggestionsContainer["rangeValues"]=true;
                                    }
...
// @ sourceURL=aria/resources/handlers/LCResourcesHandler.js
