...
Aria.classDefinition({
    ...
    $prototype : {
        ...
        _testValue : function () {
            ...
            this.assertTrue(left1 > 70, "Invalid Slider second Handle Position");
            this.assertTrue(left2 > 25, "Invalid Slider first Handle Position");
            var val = [0, 0.3];
        ...
        _checkValue : function () {
            ...
            this.assertTrue(left > 95, "Invalid Slider second Handle Position");
            this._testValue2();
        },
        ...
        _checkValue2 : function () {
            ...
            left1 = parseInt(left1.substring(0, left1.indexOf("px")), 10);
            left2 = parseInt(left2.substring(0, left2.indexOf("px")), 10);
            this.assertTrue(left1 > 225, "Invalid Slider second Handle Position");
            this.assertTrue(left2 > 105, "Invalid Slider first Handle Position");
            this.end();
        }
    }
});